...
import { ShoppingBag, Trash2, Plus, Minus, CheckCircle2, ArrowRight, Printer, Copy, Check, X } from 'lucide-react';
          ...
          <div className="fixed inset-0 z-50 overflow-hidden print:hidden" role="dialog" aria-modal="true" aria-label={t.cart_title}>
            ...
            <div className="absolute inset-y-0 end-0 max-w-full flex ps-10">
              <motion.div
                ...
                className="w-screen max-w-sm bg-zinc border-s border-white/10 shadow-2xl flex flex-col text-bone"
              >
                  ...
                  <div className="p-4 border-t border-white/5 bg-white/[0.01] space-y-3">
                    ...
                    <div className="space-y-1.5">
                      <input
                        ...
                        className="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/10 text-xs text-bone placeholder:text-ash focus:outline-none focus:border-volt/50"
                      />
                      <input
                        type="tel"
                        inputMode="numeric"
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 rounded-lg bg-white/[0.03] border border-white/10 text-xs text-bone focus:outline-none focus:border-volt/50"
                      >
        ...
        {isCheckoutSuccess && createdOrder && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative max-w-lg w-full bg-zinc border border-white/10 rounded-2xl p-5 md:p-6 shadow-2xl z-10 overflow-hidden text-bone print:border-none print:bg-white print:text-black print:p-0 print:shadow-none"
            >
              ...
              <div className="text-center mb-5 print:hidden">
                <div className="h-10 w-10 bg-volt/10 text-volt rounded-xl flex items-center justify-center mx-auto mb-2.5">
                  <CheckCircle2 className="w-5 h-5 stroke-[2]" />
                </div>
                <h3 className="text-base font-black text-bone tracking-tight mb-1">
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between gap-2.5 px-3.5 py-2.5 rounded-xl border transition-all cursor-pointer ${
                    orderKeyCopied
              ...
              <div className="flex gap-2.5 print:hidden">
                <button
                  ...
                  className="flex-1 py-2.5 bg-white/[0.05] border border-white/10 text-bone hover:bg-white/10 rounded-xl text-xs font-mono font-bold uppercase tracking-wider transition-all duration-300 cursor-pointer flex items-center justify-center gap-1.5"
                >
                ...
                <button
                  onClick={() => setIsCheckoutSuccess(false)}
                  className="flex-1 py-2.5 bg-volt text-ink rounded-xl text-xs font-mono font-bold uppercase tracking-wider hover:bg-bone transition-all duration-300 cursor-pointer shadow-md shadow-volt/5"
                >
                  {t.cart_close}
                </button>
              </div>
