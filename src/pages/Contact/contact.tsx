...
const SUPPORT_CARDS = [
  {
    ...
    title: 'Orders',
    description: 'Track your package, check order status, or modify a recent purchase before it ships.',
    cta: 'Track Order',
    href: '/tracking',
  },
  {
    ...
    title: 'Shipping',
    description: 'Explore delivery times, shipping rates, and available logistics options by region.',
    cta: 'View Rates',
    href: '/shipping',
  },
  {
    ...
    title: 'Returns',
    description: 'Free returns within 30 days. Start a return or exchange quickly through our portal.',
    cta: 'Start Return',
    href: '#',
  },
  {
    ...
    title: 'Payments',
    description: "Questions about billing, refunds, or payment methods? We've got you covered.",
    cta: 'Payment FAQ',
    href: '#',
  },
];
...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer: 'Use the Track Order page and enter your order ID (e.g. DP-98231) or tracking number. Real-time updates are pushed to your order timeline as your package moves through our logistics network.',
  },
  {
    ...
    <div className="bg-ink text-bone min-h-screen font-sans flex flex-col selection:bg-volt selection:text-ink">
      ...
      <main className="flex-grow pt-24 pb-20 px-4 sm:px-6 md:px-10 max-w-[1400px] mx-auto w-full">
        ...
        <motion.section
          ...
          className="text-center mb-20 mt-4"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/[0.02] mb-5">
            ...
            <span className="text-[10px] font-mono tracking-widest text-ash uppercase">24/7 Support</span>
          </div>
          <h1 className="text-5xl sm:text-7xl font-display font-black tracking-tight text-bone uppercase mb-5">
            Get In<br />
            <span className="text-volt">Touch</span>
          </h1>
          <p className="text-sm sm:text-base text-ash max-w-md mx-auto font-medium leading-relaxed">
            Have a question, a concern, or just want to say hello? Our team is here and happy to help — every time.
          </p>
        </motion.section>
        ...
        {/* ── 3. Form + Map ────────────────────────────────────────────────── */}
        <section className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-24">
          {/* Contact Form */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.7, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
            className="lg:col-span-3 bg-white/[0.02] border border-white/[0.06] rounded-3xl p-8 sm:p-10"
          >
            {/* Card header */}
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <div>
                    <p className="font-display font-black text-2xl uppercase text-bone mb-1">Message Sent!</p>
                    <p className="text-sm text-ash max-w-xs">We'll get back to you within 24 hours. Check your inbox.</p>
                  </div>
                  <button
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="flex flex-col gap-2">
                      <label className="text-[10px] font-mono tracking-[0.18em] uppercase text-ash">Full Name *</label>
                      <input
                        type="text"
                        name="name"
                        value={form.name}
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-[10px] font-mono tracking-[0.18em] uppercase text-ash">Email Address *</label>
                      <input
                        type="email"
                        name="email"
                        value={form.email}
                  ...
                  {/* Subject */}
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] font-mono tracking-[0.18em] uppercase text-ash">Subject</label>
                  ...
                  {/* Message */}
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] font-mono tracking-[0.18em] uppercase text-ash">Message *</label>
                    <textarea
                      name="message"
                      value={form.message}
                      onChange={handleChange}
                  ...
                  <motion.button
                    ...
                    disabled={sending}
                    whileTap={{ scale: 0.98 }}
                    className="mt-1 flex items-center justify-center gap-3 w-full py-4 bg-volt text-ink font-mono font-bold text-xs uppercase tracking-[0.15em] rounded-xl hover:bg-bone transition-colors duration-200 disabled:opacity-60 cursor-pointer"
                  >
                    {sending ? (
                      <>
                        <span className="h-4 w-4 border-2 border-ink/20 border-t-ink rounded-full animate-spin" />
                        Sending…
                      </>
                    ) : (
                      <>
          ...
          >
            {/* Map placeholder */}
            <div className="flex-1 min-h-[260px] bg-white/[0.02] border border-white/[0.06] rounded-3xl overflow-hidden relative group">
              {/* Grid background */}
              <div
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                <div className="relative">
                  <div className="w-12 h-12 rounded-full bg-volt/10 border border-volt/20 flex items-center justify-center">
                    <MapPin className="w-6 h-6 text-volt" />
                  </div>
                  <span className="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-volt animate-ping" />
                  <span className="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-volt" />
                </div>
            ...
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-3xl p-6">
              <p className="text-[10px] font-mono tracking-[0.2em] uppercase text-ash mb-4">Follow Us</p>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {SUPPORT_CARDS.map((card, i) => (
              ...
              >
                <div className="p-2.5 w-fit rounded-xl bg-white/[0.05] text-ash group-hover:text-volt group-hover:bg-volt/10 transition-all duration-300 mb-5">
                  {card.icon}
                </div>
                ...
                <span className="text-[10px] font-mono font-bold tracking-[0.15em] uppercase text-volt group-hover:gap-2 flex items-center gap-1.5 transition-all duration-200">
                  {card.cta}
        ...
        >
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/[0.02] mb-4">
              <span className="text-[10px] font-mono tracking-widest text-ash uppercase">Quick Answers</span>
            </div>
            ...
            {FAQ_DATA.map((item, i) => {
              ...
              return (
                <div key={i} className="py-1">
                  ...
                  >
                    <span className={`text-sm sm:text-base font-medium pr-6 transition-colors duration-200 ${isOpen ? 'text-volt' : 'text-bone group-hover:text-volt'}`}>
                      {item.question}
                    </span>
                    <motion.span
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <p className="pb-5 text-sm text-ash leading-relaxed pr-10">
                          {item.answer}
                        </p>
                      </motion.div>
                    )}
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: '-60px' }}
          transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
          className="relative overflow-hidden rounded-3xl border border-white/[0.06] bg-white/[0.02] p-10 sm:p-14 text-center mb-4"
        >
          {/* Subtle volt glow */}
          <div
          ...
          />
          <p className="text-[10px] font-mono tracking-[0.25em] uppercase text-ash mb-3">Still have questions?</p>
          <h2 className="font-display font-black text-3xl sm:text-5xl uppercase tracking-tight text-bone mb-4">
            We're One Message Away
          </h2>
          <p className="text-sm text-ash max-w-sm mx-auto mb-8 leading-relaxed">
            Our concierge team responds within 24 hours. For urgent matters, reach us by phone during working hours.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="mailto:support@nk-store.dz"
              className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-volt text-ink font-mono font-bold text-xs uppercase tracking-[0.15em] rounded-xl hover:bg-bone transition-colors duration-200"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-transparent border border-white/10 text-bone font-mono font-bold text-xs uppercase tracking-[0.15em] rounded-xl hover:border-volt/40 hover:text-volt transition-all duration-200"
            >
