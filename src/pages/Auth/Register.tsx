...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      toast.success('Account created! Welcome to Drippy.');
      navigate('/');
    } catch (err: unknown) {
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="name" className="text-xs font-bold uppercase tracking-wider text-ash font-mono">
                Full Name
              </label>
              <input
                id="name"
                ...
                className={`w-full px-4 py-3.5 bg-white/[0.03] border rounded-xl text-sm text-bone placeholder:text-ash/40 outline-none transition-all focus:ring-2 focus:ring-volt/20 focus:border-volt/50 ${
                  errors.name ? 'border-rose-500/60' : 'border-white/10 hover:border-white/20'
                }`}
              />
            ...
            {/* Confirm Password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="confirmPassword" className="text-xs font-bold uppercase tracking-wider text-ash font-mono">
                Confirm Password
              </label>
              <div className="relative">
                <input
          ...
          <p className="text-center text-xs text-ash/60">
            By creating an account, you agree to Drippy's{' '}
